export namespace backend {
	...
	export class UserScriptExportData {
	    version: string;
	    exportDate: string;
	    userScripts: UserDefinedCommandDefinition[];
	
	    static createFrom(source: any = {}) {
	        return new UserScriptExportData(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.userScripts = this.convertValues(source["userScripts"], UserDefinedCommandDefinition);
	    }
...
export namespace git_operations {
	...
	export class FileDiffPatch {
	    ...
	    static createFrom(source: any = {}) {
	        return new FileDiffPatch(source);
	    }
