...
import { UserDefinedParameter } from '@/hooks/command-palette/use-custom-command';
		...
		<Card className="p-4">
			<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
				...
				<div>
					...
					<Select value={parameter.type} onValueChange={(value) => onUpdate(parameterIndex, 'type', value)}>
					...
					{parameter.type === 'select' && (
						<div className="flex items-center space-x-2">
							<Checkbox
								...
								onCheckedChange={(checked) => onUpdate(parameterIndex, 'allowCustomInput', checked)}
							/>
				...
				{parameter.type === 'select' && (
					<div className="md:col-span-2">
						...
						<TagInput
							...
							onChange={(options) => onUpdate(parameterIndex, 'options', options)}
